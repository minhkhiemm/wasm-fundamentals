(module
  ...
  (func $isCrowned (param $piece i32) (result i32)
    (i32.eq
      (i32.add (get_local $piece) (get_global $CROWN))
      (get_global $CROWN)
    )
  )
  ...
  ;; Removes a crown from a given piece
  (func $withoutCrown (param $piece i32) (result i32)
    (i32.add (get_local $piece) (i32.const 3))
  )
  ...
  ;; Gets the current turm owner (white or black)
  ...
  ;; we crown black pieces in row 0.
